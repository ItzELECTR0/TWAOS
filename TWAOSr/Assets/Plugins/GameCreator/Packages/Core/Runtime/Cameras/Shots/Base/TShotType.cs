...
namespace GameCreator.Runtime.Cameras
{
    ...
    public abstract class TShotType : IShotType
    {
        ...
        [NonSerialized] protected ShotFeatureRecoil m_Recoil;
        ...
        public virtual ShotFeatureRecoil Recoil => this.m_Recoil;
        ...
        public void Awake(ShotCamera shotCamera)
        {
            ...
            this.m_Recoil = new ShotFeatureRecoil(shotCamera);
        ...
        {
            return this.m_ShotSystems.GetValueOrDefault(systemID);
        }
    }
}