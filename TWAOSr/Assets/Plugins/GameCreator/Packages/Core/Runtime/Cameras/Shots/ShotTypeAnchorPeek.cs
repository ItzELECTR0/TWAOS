...
namespace GameCreator.Runtime.Cameras
{
    ...
    public class ShotTypeAnchorPeek : TShotType
    {
        ...
        [SerializeField] private ShotSystemAnchor m_ShotSystemAnchor = new ShotSystemAnchor();
        [SerializeField] private ShotSystemPeek m_ShotSystemPeek = new ShotSystemPeek();
        ...
        public override bool HasTarget => this.Anchor.GetTargetTransform(this) != null;
        public override Vector3 Target => this.Anchor.GetTargetPosition(this);
