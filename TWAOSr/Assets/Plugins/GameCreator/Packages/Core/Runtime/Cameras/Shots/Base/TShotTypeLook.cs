...
namespace GameCreator.Runtime.Cameras
{
    ...
    public abstract class TShotTypeLook : TShotType
    {
        ...
        [SerializeField] protected ShotSystemLook m_ShotSystemLook = new ShotSystemLook();
        ...
        public override bool HasTarget => this.Look.GetLookTarget(this) != null;

        public override Vector3 Target => this.m_ShotSystemLook.GetLookPosition(this);
