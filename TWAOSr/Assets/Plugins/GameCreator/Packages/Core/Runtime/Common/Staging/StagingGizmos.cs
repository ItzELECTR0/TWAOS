...
namespace GameCreator.Runtime.Common
{
    ...
    public class StagingGizmos : MonoBehaviour
    {
        ...
        public static StagingGizmos Bind<T>(GameObject target, T asset)
            where T : ScriptableObject, IStageGizmos
        {
        ...
        public static S Bind<T, S>(GameObject target, T asset) 
            where T : ScriptableObject, IStageGizmos
            where S : StagingGizmos
        {
            S component = target.AddComponent<S>();
