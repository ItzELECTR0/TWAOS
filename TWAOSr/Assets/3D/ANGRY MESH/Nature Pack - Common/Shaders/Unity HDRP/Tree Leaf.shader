	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float temp_output_28_0_g134 = ( ( sin( ( ( ase_worldPos.z * temp_output_99_0_g134 ) + ( ( temp_output_101_0_g134 * sin( _TimeParameters.x * 0.5 ) ) + mulTime10_g134 ) ) ) * temp_output_73_0_g134 ) * temp_output_48_0_g134 );
				float temp_output_49_0_g134 = 0.0;
				float3 appendResult63_g134 = (float3(temp_output_28_0_g134 , ( ( sin( ( ( temp_output_99_0_g134 * ase_worldPos.y ) + mulTime10_g134 ) ) * temp_output_73_0_g134 ) * temp_output_49_0_g134 ) , temp_output_28_0_g134));
				...
				float temp_output_28_0_g133 = ( ( sin( ( ( ase_worldPos.z * temp_output_99_0_g133 ) + ( ( temp_output_101_0_g133 * sin( _TimeParameters.x * 0.5 ) ) + mulTime10_g133 ) ) ) * temp_output_73_0_g133 ) * temp_output_48_0_g133 );
				float temp_output_49_0_g133 = VColor_Blue1625;
				float3 appendResult63_g133 = (float3(temp_output_28_0_g133 , ( ( sin( ( ( temp_output_99_0_g133 * ase_worldPos.y ) + mulTime10_g133 ) ) * temp_output_73_0_g133 ) * temp_output_49_0_g133 ) , temp_output_28_0_g133));
...
Node;AmplifyShaderEditor.FunctionNode;1655;-2560,640;Inherit;False;AG Global Wind - Tree;-1;;133;b3a3869a2b12ed246ae10bcce7d41e6e;0;6;48;FLOAT;0;False;49;FLOAT;0;False;96;FLOAT;1;False;94;FLOAT;1;False;95;FLOAT;1;False;97;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1656;-3968,768;Inherit;False;AG Global Wind - Tree;-1;;134;b3a3869a2b12ed246ae10bcce7d41e6e;0;6;48;FLOAT;0;False;49;FLOAT;0;False;96;FLOAT;1;False;94;FLOAT;1;False;95;FLOAT;1;False;97;FLOAT;1;False;1;FLOAT3;0
...
WireConnection;1689;0;1109;0
WireConnection;1689;1;1111;0
WireConnection;1689;7;224;0
WireConnection;1689;8;208;0
WireConnection;1689;9;1638;0
WireConnection;1689;10;1115;0
WireConnection;1689;16;1673;0
WireConnection;1689;62;1674;0
WireConnection;1689;11;549;0
ASEEND*/
//CHKSM=42C39B733EBD70956AFB02A20C3C59D5EB2DBA93