...
Shader "SineVFX/ForceFieldAndShieldEffects/ForceFieldBasicTriplanarMultiple"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_109_0 = abs( ( (0.0 + (ase_vertex3Pos.y - 0.0) * (1.0 - 0.0) / (_MaskAppearLocalYRamap - 0.0)) + _MaskAppearLocalYAdd ) );
			...
			float2 localMyCustomExpression419419 = MyCustomExpression419( NegatedOffsetCE419 , FFSpherePositionsCE419 , FFSphereSizesCE419 , WorldPosCE419 , FFSphereCountCE419 , IOCE419 , TFICE419 );
			float InterceptionResult468 = localMyCustomExpression419419.y;
			...
			#else
				float4 staticSwitch336 = temp_cast_14;
			#endif
			o.Emission = ( ( _RampColorTint * _FinalPower * tex2D( _Ramp, appendResult88 ) * clampResult367 ) + staticSwitch336 ).rgb;
			float ifLocalVar409 = 0;
			if( localMyCustomExpression419419.x > _ThresholdForSpheres )
				ifLocalVar409 = 1.0;
			else if( localMyCustomExpression419419.x == _ThresholdForSpheres )
				ifLocalVar409 = 1.0;
			else if( localMyCustomExpression419419.x < _ThresholdForSpheres )
				ifLocalVar409 = 0.0;
...
/*ASEBEGIN
Version=14201
7;29;1906;1004;6.974365;-943.5626;1;True;True
...
Node;AmplifyShaderEditor.PosVertexDataNode;108;848.2285,2060.201;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;112;769.9547,2350.739;Float;False;Property;_MaskAppearLocalYRamap;Mask Appear Local Y Ramap;28;0;Create;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;122;996.108,2448.396;Float;False;Property;_MaskAppearLocalYAdd;Mask Appear Local Y Add;29;0;Create;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;111;1093.189,2182.306;Float;False;5;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;1.0;False;3;FLOAT;0.0;False;4;FLOAT;1.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;301;557.4422,2819.65;Float;True;Property;_MaskAppearNoise;Mask Appear Noise;32;0;Create;None;022104b5ac3b9e4419e61d04b021d330;False;white;Auto;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;129;520.8091,2681.508;Float;False;0;301;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;121;1327.108,2257.396;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;66;-2043.28,1794.647;Float;True;Property;_Noise01;Noise 01;17;0;Create;None;022104b5ac3b9e4419e61d04b021d330;False;white;Auto;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;305;456.9648,3042.516;Float;False;Property;_MaskAppearNoiseTriplanarTiling;Mask Appear Noise Triplanar Tiling;35;0;Create;0.2;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;110;1673.411,2217.917;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;304;1423.012,2846.063;Float;False;Property;_MaskAppearNoiseTriplanar;Mask Appear Noise Triplanar;34;0;Create;0;False;True;True;;Toggle;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;340;1032.116,434.0928;Float;False;Property;_NormalVertexOffset;Normal Vertex Offset;4;0;Create;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-1007.908,2085.772;Float;False;Property;_NoiseMaskPower;Noise Mask Power;15;0;Create;1;3.79;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;6;119.1042,249.224;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;131;2019.51,2493.006;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;117;1872.943,2395.36;Float;False;Property;_MaskAppearProgress;Mask Appear Progress;31;0;Create;0;-1.109173;-2;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;-371.784,1910.448;Float;False;3;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;118;1853.373,2275.846;Float;False;Property;_MaskAppearInvert;Mask Appear Invert;30;0;Create;0;False;False;True;;Toggle;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;416;1329.474,473.1551;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;156;-3328.869,-419.5863;Float;False;Property;_HitWaveLength;Hit Wave Length;37;0;Create;0.5;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;261;-3372.348,-180.2328;Float;False;Property;_HitWaveFadeDistance;Hit Wave Fade Distance;38;0;Create;6;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;158;-3319.869,-319.586;Float;False;Global;_PSLossyScale;_PSLossyScale;29;0;Create;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;116;2273.374,2340.846;Float;True;3;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;96;405.714,701.994;Float;False;Property;_NoiseMaskAdd;Noise Mask Add;16;0;Create;0.25;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;423;-3338.161,-2228.093;Float;False;Global;_FFSphereCount;_FFSphereCount;43;0;Create;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;77;-215.0193,1907.727;Float;False;ResultNoise;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;146;2333.237,2575.261;Float;False;Constant;_Float0;Float 0;28;0;Create;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;79;470.5437,603.4798;Float;False;77;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;371;-3626.26,-753.235;Float;False;Property;_HitWaveDistortionPower;Hit Wave Distortion Power;41;0;Create;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;300;-3077.729,-234.0128;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;369;-3585.709,-863.3238;Float;False;368;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;157;-3074.869,-390.5862;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;317;-3418.685,-83.0966;Float;False;Property;_HitWaveFadeDistancePower;Hit Wave Fade Distance Power;39;0;Create;1;2;0;0;0;1;FLOAT;0
Node;GlobalArrayNode;420;-3356.907,-2493.786;Float;False;_FFSpherePositions;0;20;2;False;2;0;INT;0;False;1;INT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;418;-3354.874,-2669.428;Float;False;417;0;1;FLOAT;0
Node;GlobalArrayNode;421;-3363.954,-2586.644;Float;False;_FFSphereSizes;0;20;0;False;2;0;INT;0;False;1;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;447;-3349.952,-2138.838;Float;False;Property;_InterceptionOffset;Interception Offset;43;0;Create;0.66;0.33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;417;1466.63,468.7429;Float;False;NegatedOffset;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;448;-3404.745,-2043.375;Float;False;Property;_ThresholdForInterception;Threshold For Interception;45;0;Create;1.001;1.001;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;160;-2934.869,-392.5862;Float;False;WL;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;377;-3314.901,-1359.05;Float;False;Global;_AffectorCount;_AffectorCount;42;0;Create;20;20;0;1;INT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;375;-3305.767,-1512.092;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;370;-3270.613,-801.4119;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;GlobalArrayNode;372;-3351.856,-1720.04;Float;False;_ControlParticlePosition;0;20;2;False;2;0;INT;0;False;1;INT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;328;703.907,1634.821;Float;False;Property;_HitWaveNoiseNegate;Hit Wave Noise Negate;36;0;Create;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;379;-3301.68,-1261.742;Float;False;262;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;344;-3350.479,-1031.263;Float;True;Property;_HitWaveRampMask;Hit Wave Ramp Mask;40;0;Create;None;ae3f66e0bf516da4faaf6395d8d99e3c;False;white;Auto;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.GetLocalVarNode;381;-3300.083,-1110.514;Float;False;160;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;380;-3304.415,-1187.691;Float;False;319;0;1;FLOAT;0
Node;GlobalArrayNode;373;-3352.281,-1613.559;Float;False;_ControlParticleSize;0;20;0;False;2;0;INT;0;False;1;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;319;-2929.685,-86.09659;Float;False;FDP;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;145;2572.514,2429.557;Float;False;FLOAT2;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;326;435.3116,1375.533;Float;False;77;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;262;-2925.415,-239.1055;Float;False;FD;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;482;663.3525,1112.403;Float;False;Property;_InterceptionNoiseNegate;Interception Noise Negate;44;0;Create;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;483;979.3526,1146.403;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;488;-2514.244,-2487.638;Float;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SamplerNode;147;2713.835,2406.339;Float;True;Property;_MaskAppearRamp;Mask Appear Ramp;33;0;Create;None;81f58b421b2edce4c997c876e45c49f7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;327;1011.908,1577.821;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;342;-2378.473,-1186.791;Float;False;HWArrayResult;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;484;1107.354,1145.403;Float;False;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;1.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;338;1038.654,1722.374;Float;False;119;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;468;-2156.125,-2631.9;Float;False;InterceptionResult;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;119;3055.928,2487.086;Float;False;MaskAppearValue;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;489;978.8257,1274.632;Float;False;Property;_InterceptionPower;Interception Power;42;0;Create;1;1;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;329;1135.908,1578.821;Float;False;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;1.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;481;1076.495,1019.634;Float;False;119;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;477;1068.059,927.5905;Float;False;468;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;343;1044.822,1428.324;Float;False;342;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;135;3053.369,2395.224;Float;False;MaskAppearEdges;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;138;1342.792,806.6533;Float;False;135;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;479;1378.911,979.9116;Float;False;4;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;325;1372.159,1525.798;Float;False;3;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;137;1636.792,738.6533;Float;False;4;4;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;411;-2449.448,-1990.498;Float;False;Constant;_Float12;Float 12;25;0;Create;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;410;-2284.602,-2190.643;Float;False;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;412;-2441.133,-1903.276;Float;False;Constant;_Float13;Float 13;25;0;Create;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;413;-2466.811,-2088.437;Float;False;Property;_ThresholdForSpheres;Threshold For Spheres;46;0;Create;0.99;0.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ConditionalIfNode;409;-2141.841,-2328.923;Float;False;False;5;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;778.2527,-886.0862;Float;False;Property;_FinalPower;Final Power;0;0;Create;4;4;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ObjectScaleNode;424;1071.274,185.7547;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;487;1032.234,-7.874146;Float;False;486;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;90;760.9977,-794.5371;Float;True;Property;_Ramp;Ramp;7;0;Create;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;486;-1964.928,-2332.095;Float;False;SpheresResult;-1;True;1;0;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;89;842.3301,-1064.289;Float;False;Property;_RampColorTint;Ramp Color Tint;8;0;Create;1,1,1,1;1,1,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldNormalVector;339;1271.655,124.4214;Float;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;425;1326.495,324.3658;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;360;1293.148,-153.7206;Float;False;3;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;341;1517.639,220.3678;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;362;1595.303,-160.5372;Float;False;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;1.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1848.978,-399.8422;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;SineVFX/ForceFieldAndShieldEffects/ForceFieldBasicTriplanarMultiple;False;False;False;False;True;True;True;True;True;False;True;True;False;False;True;False;False;Off;0;0;False;0;0;Transparent;0.5;True;False;0;False;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;2;15;10;25;False;0.5;False;2;SrcAlpha;OneMinusSrcAlpha;0;Zero;Zero;OFF;OFF;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=AF45CCC3695D4D7D08D4381099418E2D7A12206A