...
namespace UnityEditor.Sequences
{
    ...
    {
        static readonly string k_USSFilePath = "Packages/com.unity.sequences/Editor/Core/UI/UIControls/RenameableLabel/RenameableLabel.uss";

        public static readonly string ussClassName = "seq-renameable-label";
