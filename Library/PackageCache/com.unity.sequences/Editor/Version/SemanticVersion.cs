/// Source file from ProBuilder 4.4.0
/// https://github.com/Unity-Technologies/com.unity.probuilder/blob/master/Runtime/Core/SemVer.cs
...
namespace UnityEditor.Sequences
{
    ...
    sealed class SemanticVersion : IEquatable<SemanticVersion>, IComparable<SemanticVersion>, IComparable
    {
        ...
        /// </summary>
        public SemanticVersion MajorMinorPatch
        {
        ...
        public SemanticVersion(string formatted, string date = null)
        {
        ...
        public SemanticVersion(int major, int minor, int patch, int build = -1, string type = null, string date = null, string metadata = null)
        {
            m_Major = major;
            m_Minor = minor;
            m_Patch = patch;
        ...
        {
            return o is SemanticVersion && Equals((SemanticVersion)o);
        }
        ...
        public bool Equals(SemanticVersion version)
        {
        ...
        /// <returns></returns>
        public static bool TryGetVersionInfo(string input, out SemanticVersion version)
        {
