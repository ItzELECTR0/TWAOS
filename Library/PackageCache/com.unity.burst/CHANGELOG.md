...
- Fixed recursive structs hidden behind layers of pointer indirection could cause the compiler to get stuck in an infinite loop
- Fixed the documentation on [NoAlias] struct fields
- Fixed incorrect alias analysis in certain edge-cases
