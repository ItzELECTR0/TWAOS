	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 appendResult8_g54 = (float2(ase_worldPos.x , ase_worldPos.z));
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3 = vertexToFrag18_g54;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 lerpResult19_g54 = lerp( temp_cast_2 , lerpResult17_g54 , AG_TintToggle);
				float4 vertexToFrag18_g54 = lerpResult19_g54;
				outputPackedVaryingsMeshToPS.ase_texcoord8 = vertexToFrag18_g54;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * ( unity_WorldTransformParams.w >= 0.0 ? 1.0 : -1.0 );
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
...
Node;AmplifyShaderEditor.FunctionNode;295;640,512;Inherit;False;AG Global Tint Color;0;;54;1dcc860732522ee469468f952b4e8aa1;0;3;27;COLOR;0,0,0,0;False;28;COLOR;0,0,0,0;False;22;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;298;-896,512;Inherit;False;AG Global Snow - Grass;-1;;55;ac8896bffa708e24e91ea416ba6ae274;0;4;22;FLOAT;0;False;24;FLOAT;0;False;23;FLOAT;0;False;25;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;313;-896,672;Inherit;False;AG Global Snow - Height;-1;;56;792d553d9b3743f498843a42559debdb;0;0;1;FLOAT;43
...
WireConnection;331;1;158;0
WireConnection;331;7;134;0
WireConnection;331;9;57;0
WireConnection;331;10;217;0
WireConnection;331;16;316;0
WireConnection;331;62;315;0
WireConnection;331;11;160;0
ASEEND*/
//CHKSM=BB5826CE26D775D1B1CFE452A82FD76E0AE19210