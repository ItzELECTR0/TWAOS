	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float temp_output_28_0_g142 = ( ( sin( ( ( ase_worldPos.z * temp_output_99_0_g142 ) + ( ( temp_output_101_0_g142 * sin( _TimeParameters.x * 0.5 ) ) + mulTime10_g142 ) ) ) * temp_output_73_0_g142 ) * temp_output_48_0_g142 );
				float temp_output_49_0_g142 = VColor_Blue1625;
				float3 appendResult63_g142 = (float3(temp_output_28_0_g142 , ( ( sin( ( ( temp_output_99_0_g142 * ase_worldPos.y ) + mulTime10_g142 ) ) * temp_output_73_0_g142 ) * temp_output_49_0_g142 ) , temp_output_28_0_g142));
				...
				float2 appendResult8_g143 = (float2(ase_worldPos.x , ase_worldPos.z));
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3 = vertexToFrag18_g143;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 vertexToFrag18_g143 = packedInput.ase_texcoord3;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float4 lerpResult19_g143 = lerp( temp_cast_2 , lerpResult17_g143 , AG_TintToggle);
				float4 vertexToFrag18_g143 = lerpResult19_g143;
				outputPackedVaryingsMeshToPS.ase_texcoord8 = vertexToFrag18_g143;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * ( unity_WorldTransformParams.w >= 0.0 ? 1.0 : -1.0 );
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
						...
						)
			{
				...
				float4 tex2DNode162 = tex2D( _MainTex, uv_MainTex162 );
				float4 vertexToFrag18_g143 = packedInput.ase_texcoord8;
				half4 TintColor1462 = vertexToFrag18_g143;
				float4 temp_output_163_0 = ( _Color * tex2DNode162 * TintColor1462 );
...
Node;AmplifyShaderEditor.FunctionNode;1655;-2560,1152;Inherit;False;AG Global Wind - Tree;-1;;142;b3a3869a2b12ed246ae10bcce7d41e6e;0;6;48;FLOAT;0;False;49;FLOAT;0;False;96;FLOAT;1;False;94;FLOAT;1;False;95;FLOAT;1;False;97;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1660;-4864,128;Inherit;False;AG Global Tint Color;0;;143;1dcc860732522ee469468f952b4e8aa1;0;3;27;COLOR;0,0,0,0;False;28;COLOR;0,0,0,0;False;22;FLOAT;0;False;1;COLOR;0
...
WireConnection;1824;0;1109;0
WireConnection;1824;1;1111;0
WireConnection;1824;7;224;0
WireConnection;1824;8;208;0
WireConnection;1824;9;1638;0
WireConnection;1824;10;1115;0
WireConnection;1824;16;1791;0
WireConnection;1824;62;1790;0
WireConnection;1824;11;549;0
ASEEND*/
//CHKSM=554F5B5123229B8D4AD33D72C901617BD4D9B685